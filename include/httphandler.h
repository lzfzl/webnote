...
public:
    ...
    enum HTTP_CODE{DATA,BAD_REQUEST,NO_REQUEST,GET_REQUEST,INTERNAL_ERROR,FILE_REQUEST,NO_SOURCE,OPTIONS,WRONGLOGIN,SUCCESSLOGIN,SUCCESSSIGNUP,WRONGSIGNUP,CREATEPLAN,ADDPLAN,DELETEPLAN};
